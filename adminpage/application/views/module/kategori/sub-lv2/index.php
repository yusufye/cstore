                    ...
                    <table class="table align-items-center table-flush table-hover" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <a href="javascript:prosesHapus('kategori/hapusSubLv2/<?=$data['kategori_sub_lv2_id'];?>');" class="btn btn-danger btn-sm font-size-12"><i class="fa fa-trash"></i></a>
                                    <a href="#" onclick="modalNormal('<?=base_url('kategori/editSubLv2/').$data['kategori_sub_lv2_id']?>')" class="btn btn-warning btn-sm font-size-12">Edit</a>
                                </td>
                            </tr>
                            <?php $no++; endforeach; ?>
                        </tbody>
...
<div class="modal fade" id="modalData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="tambahform" action="javascript:prosesDefault('kategori/sublv2/proses','tambahform')" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="modalDataKpilihan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="tambahformx" action="javascript:prosesDefault('kategori/pilihanSubkategoriLv2','tambahformx')" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                      <select class="form-control selectpicker" data-max-options="5" data-live-search="true" multiple="" title="-- Pilih --" name="kategori_sub_lv2_id[]" required="">
                        <?php foreach ($all_data as $datarl) : ?>
                        <?php $is = $this->auth->getById('ui_kategori_sub_lv2','kategori_sub_lv2_id',$datarl['kategori_sub_lv2_id']) ?>
                        <option value="<?=$datarl['kategori_sub_lv2_id'];?>" <?php if ($is) echo 'selected'; ?>><?=$datarl['nama_kategori'];?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                    <div class="mt-1">
